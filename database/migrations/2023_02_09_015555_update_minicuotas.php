...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        */
        Schema::create('product_minicuota_store', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_minicuota')->nullable();
            $table->foreign('id_minicuota')->references('id')->on('mini_cuotas')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('product_minicuota_store', function (Blueprint $table) {
            $table->dropConstrainedForeignId('id_store');
            $table->dropConstrainedForeignId('id_product');
            $table->dropConstrainedForeignId('id_minicuota');
        });
    }
};
